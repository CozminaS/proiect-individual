 ...
 * @author Cozmina
 */
public class AnimaleMiciActivitati extends javax.swing.JFrame {

    /**
     * Creates new form AnimaleMiciActivitati
     */
    public AnimaleMiciActivitati() {
        initComponents();
    }
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        ...
        afisProdus("animale mici","activitati");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AnimaleMiciActivitati.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AnimaleMiciActivitati().setVisible(true);
            }
        });
    }
