 ...
 * @author Cozmina
 */
public class PisiciHrana extends javax.swing.JFrame {

    /**
     * Creates new form PisiciHrana
     */
    public PisiciHrana() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(PisiciHrana.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new PisiciHrana().setVisible(true);
            }
        });
    }
