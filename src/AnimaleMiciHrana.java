 ...
 * @author Cozmina
 */
public class AnimaleMiciHrana extends javax.swing.JFrame {

    /**
     * Creates new form AnimaleMiciHrana
     */
    public AnimaleMiciHrana() {
        initComponents();
    }
  ...
  AdaugaProdusCos c=new AdaugaProdusCos();
        c.setVisible(true);    }//GEN-LAST:event_jButton9ActionPerformed

    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        // TODO add your handling code here:
        produseAfis.setText(null);
        afisProdus("animale mici","hrana");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AnimaleMiciHrana.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AnimaleMiciHrana().setVisible(true);
            }
        });
    }
